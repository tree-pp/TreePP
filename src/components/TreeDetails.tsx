		...
		(
			...
			<div className='flex flex-col md:flex-row justify-center items-center py-12'>
				...
				<div className='flex flex-col'>
					<p className='flex justify-center items-center md:justify-start font-bold text-2xl text-slate-800 md:pl-16 pt-3'>
						Tree details
					</p>
					<div className='flex flex-row'>
						...
						<div className='flex flex-col  pt-5'>
							<p className='font-bold text-sm text-slate-800 pl-16 py-2'>
								{tree.id}
							</p>
							<p className='font-bold text-sm text-slate-800 pl-16 py-2 italic'>
								{tree.name}
							</p>
							<p className='font-bold text-sm text-slate-800 pl-16 py-2'>
								{tree.commonName}
